                ...
                <form action="{{ route('videos.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input name="title" type="text" value="{{ old('title') }}" class="form-control" placeholder="{{ __('public.title') }}">
                        </div>
                        <div class="col-md-6">
                            <label>@lang('public.slug')</label>
                            <input name="slug" type="text" value="{{ old('slug') }}" class="form-control" placeholder="{{ __('public.slug') }}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" class="form-control" rows="4" placeholder="{{ __('public.description') }}">{{ old('description') }}</textarea>
                        </div>
                        <div class="col-md-6">
